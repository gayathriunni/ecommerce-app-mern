	...
	return (
		...
		>
			<div className='space-y-4'>
				<div>
					...
					<input
						type='text'
						id='voucher'
						className='block w-full rounded-lg border border-gray-200 bg-gray-400 
            p-2.5 text-sm text-gray-600 placeholder-gray-600 focus:border-indigo-500 
			...
			{isCouponApplied && coupon && (
				<div className='mt-4'>
					<h3 className='text-lg font-medium text-gray-500'>Applied Coupon</h3>
