...
const stripePromise = loadStripe(
	"pk_test_51QD7X4JrDdUGZGArx1rRXlq1u8GHcrpwJPyYbiIxQw9FTHMHuZ7DtYCKHl3vQQHlyb5lrsHVoR8723qyO65AYh6x00RN2g8LeR"
);
...
const OrderSummary = () => {
	...
	return (
		<motion.div
			className='space-y-4 rounded-lg border border-gray-200 bg-gray-300 p-4 shadow-sm sm:p-6'
			...
			<div className='space-y-4'>
				<div className='space-y-2'>
					<dl className='flex items-center justify-between gap-4'>
						...
						<dd className='text-base font-medium text-indigo-500'>${formattedSubtotal}</dd>
					</dl>
					...
					<dl className='flex items-center justify-between gap-4 border-t border-gray-600 pt-2'>
						<dt className='text-base font-bold text-indigo-500'>Total</dt>
