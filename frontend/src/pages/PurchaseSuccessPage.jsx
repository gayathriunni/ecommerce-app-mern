		...
		<div className='h-screen flex items-center justify-center px-4'>
			...
			<div className='max-w-md w-full bg-gray-300 rounded-lg shadow-xl overflow-hidden relative z-10'>
				<div className='p-6 sm:p-8'>
					...
					<div className='bg-gray-400 rounded-lg p-4 mb-6'>
						<div className='flex items-center justify-between mb-2'>
							...
							<span className='text-sm font-semibold text-gray-200'>#12345</span>
						</div>
						<div className='flex items-center justify-between'>
							<span className='text-sm text-gray-800'>Estimated delivery</span>
							<span className='text-sm font-semibold text-gray-200'>3-5 business days</span>
						</div>
					</div>
             ...
             rounded-lg transition duration-300 flex items-center justify-center'
						...
						<Link
							to={"/"}
							className='w-full bg-indigo-800 hover:bg-indigo-600 text-gray-100 font-bold py-2 px-4 
            rounded-lg transition duration-300 flex items-center justify-center'
						>
							Continue Shopping
